...
class Cave:
  ...
  def __init__(self, rock_paths):
    ...
    cave_height = max_y + Cave.FLOOR_OFFSET
    ...
    floor_y = max_y + Cave.FLOOR_OFFSET
    floor_start = (min_x - Cave.MARGIN_LEFT, floor_y)
    floor_end = (max_x + Cave.MARGIN_RIGHT, floor_y)
    self._set_path(floor_start, floor_end)
